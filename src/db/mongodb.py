...
class PyMongo():
    def __init__(self):  # host='localhost', db='opensource', port=27017, timeout=1000, user='', password=''
        self.MONGO_DATABASE = "tienda"
        self.MONGO_URI = F'mongodb+srv://armando1546:AccesoPermitido@myfirstcluster.wtyy1eo.mongodb.net' \
